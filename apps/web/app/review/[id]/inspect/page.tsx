 ...
 * Geometry inspector.
 *
 * Not the product surface — that is the review page one level up. This stays
 * reachable because when a highlight lands in the wrong place, the first question
 * is always whether the underlying boxes were right, and nothing else answers it.
 * Losing that would mean debugging geometry faults through the mapping.
 */
    ...
    >
      <header style={{ display: "flex", flexDirection: "column", gap: "var(--sp-1)" }}>
        ...
        >
          ...
          <Link href={`/review/${id}`}>Review</Link> · geometry inspector
        </p>
